import type {Audit,Disruption,Envelope,Flight,Recovery} from './types';
...
export const api={
  ...
  createRecovery:(disruption_id:string)=>request<Envelope>('/api/v1/recoveries',{method:'POST',body:JSON.stringify({disruption_id,partition_id:'ORD',objective:'balanced'})}),
